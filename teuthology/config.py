...
class TeuthologyConfig(YamlConfig):
    ...
    _defaults = {
        ...
        'lab_domain': '',
        'lock_server': None, #'http://paddles.front.sepia.ceph.com/',
        'max_job_time': 259200,  # 3 days
        'results_server': None, #'http://paddles.front.sepia.ceph.com/',
        'results_ui_server': None, #'http://pulpito.ceph.com/',
        'results_sending_email': 'branto@redhat.com',
